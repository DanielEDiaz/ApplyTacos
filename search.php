	      ...
	      <section class="content">
	        <div class="row">
	            ...
	            <?php
	       			...
	       			$row = $stmt->fetch();
	       			if($row['numrows'] < 1){
	       				echo '<h1 class="page-header">No se han encontrado resultados para <i>'.$_POST['keyword'].'</i></h1>';
	       			}
	       			else{
	       				echo '<h1 class="page-header">Resultados de búsqueda de <i>'.$_POST['keyword'].'</i></h1>';
		       			try{
		       			 	$inc = 3;	
							...
							echo "Hay algunos problemas en la conexion: " . $e->getMessage();
						}
					}
